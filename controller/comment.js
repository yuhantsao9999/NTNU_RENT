...
const comment_publish = async (data) => {
    ...
    console.log('comment_publish data', data);
    const sql = `INSERT Eval (contract_id, publish_star, publish_comment) 
    VALUES (${contract_id}, ${star_number}, '${comment_textarea}') ON DUPLICATE KEY 
    UPDATE publish_star = ${star_number}, publish_comment = '${comment_textarea}'`;
...
const comment_rent = async (data) => {
    ...
    console.log('comment_rent data', data);
